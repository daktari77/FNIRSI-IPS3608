...
- grafico realtime con asse X temporale e range Y operativo 0..40 V
- nessun valore negativo visibile nel grafico di tensione/corrente
- autoscale ridefinito sui dati visibili ma limitato a 40 V
